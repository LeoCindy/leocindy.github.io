...
(function (e, t) {
    ...
    function a() {
        (ft.addEventListener || event.type === "load" || ft.readyState === "complete") && (s(), rt.ready())
    }
    ...
    function u(e, t, n, i) {
        if (rt.acceptData(e)) {
            ...
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t) return c || (c = a ? e[s] = V.pop() || rt.guid++ : s), l[c] || (l[c] = a ? {} : {toJSON: rt.noop}), ("object" == typeof t || "function" == typeof t) && (i ? l[c] = rt.extend(l[c], t) : l[c].data = rt.extend(l[c].data, t)), o = l[c], i || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[rt.camelCase(t)] = n), "string" == typeof t ? (r = o[t], null == r && (r = o[rt.camelCase(t)])) : r = o, r
        }
    }
    ...
    function d(e, t, n) {
        if (rt.acceptData(e)) {
            ...
            if (s[a]) {
                ...
                (n || (delete s[a].data, c(s[a]))) && (o ? rt.cleanData([e], !0) : nt.deleteExpando || s != s.window ? delete s[a] : s[a] = null)
            }
        }
    }
    ...
    function g(e, t) {
        ...
        if (!o) for (o = [], n = e.childNodes || e; (i = n[r]) != null; r++) !t || rt.nodeName(i, t) ? o.push(i) : rt.merge(o, g(i, t));
    ...
    function w(e, t) {
        for (var n, i = 0; (n = e[i]) != null; i++) rt._data(n, "globalEval", !t || rt._data(t[i], "globalEval"))
    }
    ...
    function T(e, t) {
        if (t.nodeType === 1 && rt.hasData(e)) {
            ...
            if (a) {
                ...
                for (n in a) for (i = 0, r = a[n].length; r > i; i++) rt.event.add(t, n, a[n][i])
            }
    ...
    function _(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (o[s] = rt._data(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), i.style.display === "" && _t(i) && (o[s] = rt._data(i, "olddisplay", S(i.nodeName)))) : (r = _t(i), (n && "none" !== n || !r) && rt._data(i, "olddisplay", r ? n : rt.css(i, "display"))));
        for (s = 0; a > s; s++) i = e[s], i.style && (t && i.style.display !== "none" && i.style.display !== "" || (i.style.display = t ? o[s] || "" : "none"));
        return e
    }
    ...
    function D(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += rt.css(e, n + Nt[o], !0, r)), i ? ("content" === n && (s -= rt.css(e, "padding" + Nt[o], !0, r)), "margin" !== n && (s -= rt.css(e, "border" + Nt[o] + "Width", !0, r))) : (s += rt.css(e, "padding" + Nt[o], !0, r), "padding" !== n && (s += rt.css(e, "border" + Nt[o] + "Width", !0, r)));
        return s
    }

    function j(e, t, n) {
        var i = !0, r = "width" === t ? e.offsetWidth : e.offsetHeight, o = en(e),
    ...
    function H(e, t) {
        ...
        for (t = t ? 1 : 0; 4 > r; r += 2 - t) n = Nt[r], i["margin" + n] = i["padding" + n] = e;
    ...
    function M(e, t, n) {
        ...
        n.queue || (a = rt._queueHooks(e, "fx"), a.unqueued == null && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function () {
            a.unqueued || l()
        }), a.unqueued++, d.always(function () {
            d.always(function () {
                a.unqueued--, rt.queue(e, "fx").length || a.empty.fire()
            })
        })), e.nodeType === 1 && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], c = rt.css(e, "display"), u = "none" === c ? rt._data(e, "olddisplay") || S(e.nodeName) : c, "inline" === u && rt.css(e, "float") === "none" && (nt.inlineBlockNeedsLayout && S(e.nodeName) !== "inline" ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", nt.shrinkWrapBlocks() || d.always(function () {
            h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
        }));
        for (i in t) if (r = t[i], gn.exec(r)) {
            if (delete t[i], o = o || "toggle" === r, r === (f ? "hide" : "show")) {
                if ("show" !== r || !m || m[i] === void 0) continue;
                f = !0
            }
            p[i] = m && m[i] || rt.style(e, i)
        } else c = void 0;
        if (rt.isEmptyObject(p)) ("none" === c ? S(e.nodeName) : c) === "inline" && (h.display = c); else {
            ...
            for (i in p) s = q(f ? m[i] : 0, i, d), i in m || (m[i] = s.start, f && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }

    function F(e, t) {
        var n, i, r, o, s;
        for (n in e) if (i = rt.camelCase(n), r = t[i], o = e[n], rt.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), s = rt.cssHooks[i], s && "expand" in s) {
    ...
    function O(e, t, n) {
        var i, r, o = 0, s = bn.length, a = rt.Deferred().always(function () {
            ...
            if (r) return !1;
            for (var t = fn || P(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i, s = 0, l = c.tweens.length; l > s; s++) c.tweens[s].run(o);
        ...
        for (F(u, c.opts.specialEasing); s > o; o++) if (i = bn[o].call(c, e, u, c.opts)) return i;
        return rt.map(u, q, c), rt.isFunction(c.opts.start) && c.opts.start.call(e, c), rt.fx.timer(rt.extend(l, {
            elem: e,
            anim: c,
            queue: c.opts.queue
    ...
    function R(e, t) {
        ...
        for (i in t) t[i] !== void 0 && ((r[i] ? e : n || (n = {}))[i] = t[i]);
    ...
    function I(e, t, n, i) {
        ...
        }); else if (n || rt.type(t) !== "object") i(e, t); else for (r in t) I(e + "[" + r + "]", t[r], n, i)
    }
    ...
    var V = [], K = V.slice, J = V.concat, G = V.push, Q = V.indexOf, Z = {}, et = Z.toString, tt = Z.hasOwnProperty,
        nt = {}, it = "1.11.1", rt = function (e, t) {
            return new rt.fn.init(e, t)
        }, ot = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, st = /^-ms-/, at = /-([\da-z])/gi, lt = function (e, t) {
    ...
    rt.fn = rt.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || rt.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++) if ((r = arguments[a]) != null) for (i in r) e = s[i], n = r[i], s !== n && (c && n && (rt.isPlainObject(n) || (t = rt.isArray(n))) ? (t ? (t = !1, o = e && rt.isArray(e) ? e : []) : o = e && rt.isPlainObject(e) ? e : {}, s[i] = rt.extend(c, o, n)) : void 0 !== n && (s[i] = n));
        return s
    }, rt.extend({
        expando: "jQuery" + (it + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i, r;
            return "string" == typeof t && (r = e[t], t = e, e = r), rt.isFunction(e) ? (n = K.call(arguments, 2), i = function () {
 ...
 */
        function (e) {
            function t(e, t, n, i) {
                ...
                if ((t ? t.ownerDocument || t : z) !== L && j(t), t = t || L, n = n || [], !e || "string" != typeof e) return n;
                if ((a = t.nodeType) !== 1 && 9 !== a) return [];
                if (H && !i) {
                    if (r = yt.exec(e)) if (s = r[1]) {
                        ...
                        if ((s = r[3]) && w.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(s)), n
                    }
                    if (w.qsa && (!q || !q.test(e))) {
                        if (h = d = B, f = t, m = 9 === a && e, 1 === a && t.nodeName.toLowerCase() !== "object") {
                            for (c = S(e), (d = t.getAttribute("id")) ? h = d.replace(xt, "\\$&") : t.setAttribute("id", h), h = "[id='" + h + "'] ", l = c.length; l--;) c[l] = h + p(c[l]);
            ...
            function h(e, t, n) {
                ...
                return t.first ? function (t, n, o) {
                    for (; t = t[i];) if (t.nodeType === 1 || r) return e(t, n, o)
                } : function (t, n, s) {
                    var a, l, c = [R, o];
                    if (s) {
                        for (; t = t[i];) if ((t.nodeType === 1 || r) && e(t, n, s)) return !0
                    } else for (; t = t[i];) if (t.nodeType === 1 || r) {
                        if (l = t[B] || (t[B] = {}), (a = l[i]) && a[0] === R && a[1] === o) return c[2] = a[2];
            ...
            function v(e, t, n, r, o, s) {
                return r && !r[B] && (r = v(r)), o && !o[B] && (o = v(o, s)), i(function (i, s, a, l) {
                    var c, u, d, p = [], h = [], f = s.length, v = i || m(t || "*", a.nodeType ? [a] : a, []),
                        y = !e || !i && t ? v : g(v, p, e, a, l), b = n ? o || (i ? e : f || r) ? [] : s : y;
                    ...
                    if (i) {
                        if (o || e) {
                            ...
                            for (u = b.length; u--;) (d = b[u]) && (c = o ? tt.call(i, d) : p[u]) > -1 && (i[c] = !(s[c] = d))
                        }
            ...
            function y(e) {
                ...
                }]; r > a; a++) if (n = T.relative[e[a].type]) u = [h(f(u), n)]; else {
                    if (n = T.filter[e[a].type].apply(null, e[a].matches), n[B]) {
                        for (i = ++a; r > i && !T.relative[e[i].type]; i++) ;
                        return v(a > 1 && f(u), a > 1 && p(e.slice(0, a - 1).concat({value: e[a - 2].type === " " ? "*" : ""})).replace(lt, "$1"), n, i > a && y(e.slice(a, i)), r > i && y(e = e.slice(i)), r > i && p(e))
                    }
                    u.push(n)
                }
                return f(u)
            ...
            function b(e, n) {
                var r = n.length > 0, o = e.length > 0, s = function (i, s, a, l, c) {
                    var u, d, p, h = 0, f = "0", m = i && [], v = [], y = _, b = i || o && T.find.TAG("*", c),
            ...
            var x, w, T, E, k, S, C, N, _, A, D, j, L, P, H, q, M, F, O, B = "sizzle" + -new Date, z = e.document,
                R = 0, W = 0, X = n(), I = n(), $ = n(), Y = function (e, t) {
                    return e === t && (D = !0), 0
                }, U = "undefined", V = 1 << 31, K = {}.hasOwnProperty, J = [], G = J.pop, Q = J.push, Z = J.push,
                et = J.slice, tt = J.indexOf || function (e) {
                ...
                dt = new RegExp("=" + it + "*([^\\]'\"]*?)" + it + "*\\]", "g"), pt = new RegExp(at),
                ht = new RegExp("^" + ot + "$"), ft = {
                    ID: new RegExp("^#(" + rt + ")"),
                    CLASS: new RegExp("^\\.(" + rt + ")"),
                ...
                yt = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, bt = /[+~]/, xt = /'|\\/g,
                wt = new RegExp("\\\\([\\da-f]{1,6}" + it + "?|(" + it + ")|.)", "ig"), Tt = function (e, t, n) {
                    var i = "0x" + t - 65536;
                    return i !== i || n ? t : 0 > i ? String.fromCharCode(i + 65536) : String.fromCharCode(55296 | i >> 10, 56320 | 1023 & i)
                };
            try {
                Z.apply(J = et.call(z.childNodes), z.childNodes), J[z.childNodes.length].nodeType
            } catch (Et) {
                Z = {
            ...
            w = t.support = {}, k = t.isXML = function (e) {
                ...
                return n !== L && n.nodeType === 9 && n.documentElement ? (L = n, P = n.documentElement, H = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
                    j()
                ...
                }, M = [], q = [], (w.qsa = vt.test(n.querySelectorAll)) && (r(function (e) {
                    e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && q.push("[*^$]=" + it + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || q.push("\\[" + it + "*(?:value|" + nt + ")"), e.querySelectorAll(":checked").length || q.push(":checked")
                }), r(function (e) {
                    var t = n.createElement("input");
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && q.push("name" + it + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || q.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), q.push(",.*:")
                    ...
                    w.disconnectedMatch = F.call(e, "div"), F.call(e, "[s!='']:x"), M.push("!=", at)
                }), q = q.length && new RegExp(q.join("|")), M = M.length && new RegExp(M.join("|")), t = vt.test(P.compareDocumentPosition), O = t || vt.test(P.contains) ? function (e, t) {
                    ...
                    return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !w.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === z && O(z, e) ? -1 : t === n || t.ownerDocument === z && O(z, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & i ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return D = !0, 0;
                ...
                if ((e.ownerDocument || e) !== L && j(e), n = n.replace(dt, "='$1']"), !(!w.matchesSelector || !H || M && M.test(n) || q && q.test(n))) try {
                    var i = F.call(e, n);
                    if (i || w.disconnectedMatch || e.document && e.document.nodeType !== 11) return i
                } catch (r) {
                }
                ...
                preFilter: {
                    ATTR: function (e) {
                        ...
                        var t, n = !e[6] && e[2];
                        return ft.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && pt.test(n) && (t = S(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3))
                    }
                },
                filter: {
                    TAG: function (e) {
                        ...
                        return function (r) {
                            var o = t.attr(r, e);
                            return null == o ? "!=" === n : n ? (o += "", "=" === n ? o === i : "!=" === n ? o !== i : "^=" === n ? i && o.indexOf(i) === 0 : "*=" === n ? i && o.indexOf(i) > -1 : "$=" === n ? i && o.slice(-i.length) === i : "~=" === n ? (" " + o + " ").indexOf(i) > -1 : "|=" === n ? o === i || o.slice(0, i.length + 1) === i + "-" : !1) : !0
                        }
                    }, CHILD: function (e, t, n, i, r) {
                        var o = e.slice(0, 3) !== "nth", s = e.slice(-4) !== "last", a = "of-type" === t;
                        return 1 === i && 0 === r ? function (e) {
                            return !!e.parentNode
                        } : function (t, n, l) {
                            var c, u, d, p, h, f, m = o !== s ? "nextSibling" : "previousSibling", g = t.parentNode,
                                v = a && t.nodeName.toLowerCase(), y = !l && !a;
                            if (g) {
                                if (o) {
                                    for (; m;) {
                                        for (d = t; d = d[m];) if (a ? d.nodeName.toLowerCase() === v : d.nodeType === 1) return !1;
                                        f = m = "only" === e && !f && "nextSibling"
                                    }
                                    return !0
                                }
                                if (f = [s ? g.firstChild : g.lastChild], s && y) {
                                    for (u = g[B] || (g[B] = {}), c = u[e] || [], h = c[0] === R && c[1], p = c[0] === R && c[2], d = h && g.childNodes[h]; d = ++h && d && d[m] || (p = h = 0) || f.pop();) if (d.nodeType === 1 && ++p && d === t) {
                                        u[e] = [R, h, p];
                                        break
                                    }
                                } else if (y && (c = (t[B] || (t[B] = {}))[e]) && c[0] === R) p = c[1]; else for (; (d = ++h && d && d[m] || (p = h = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : d.nodeType !== 1) || !++p || (y && ((d[B] || (d[B] = {}))[e] = [R, p]), d !== t));) ;
                ...
                pseudos: {
                    not: i(function (e) {
                        ...
                        return ht.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(wt, Tt).toLowerCase(), function (t) {
                            var n;
                            do if (n = H ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return n = n.toLowerCase(), n === e || n.indexOf(e + "-") === 0; while ((t = t.parentNode) && t.nodeType === 1);
                            return !1
                        }
                    }), target: function (t) {
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = t.tokenize = function (e, n) {
                ...
                for (a = e, l = [], c = T.preFilter; a;) {
                    ...
                    for (s in T.filter) !(r = ft[s].exec(a)) || c[s] && !(r = c[s](r)) || (i = r.shift(), o.push({
                        value: i,
                        type: s,
                        matches: r
                    }), a = a.slice(i.length));
                ...
                var n, i = [], r = [], o = $[e + " "];
                if (!o) {
                    for (t || (t = S(e)), n = t.length; n--;) o = y(t[n]), o[B] ? i.push(o) : r.push(o);
                ...
                if (n = n || [], d.length === 1) {
                    if (o = d[0] = d[0].slice(0), o.length > 2 && (s = o[0]).type === "ID" && w.getById && t.nodeType === 9 && H && T.relative[o[1].type]) {
                        if (t = (T.find.ID(s.matches[0].replace(wt, Tt), t) || [])[0], !t) return n;
                        c && (t = t.parentNode), e = e.slice(o.shift().value.length)
                    }
                    for (r = ft.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !T.relative[a = s.type]);) if ((l = T.find[a]) && (i = l(s.matches[0].replace(wt, Tt), bt.test(o[0].type) && u(t.parentNode) || t))) {
                        if (o.splice(r, 1), e = i.length && p(o), !e) return Z.apply(n, i), n;
                        break
                    }
                }
                return (c || C(e, d))(i, t, !H, n, bt.test(e) && u(t.parentNode) || t), n
            }, w.sortStable = B.split("").sort(Y).join("") === B, w.detectDuplicates = !!D, j(), w.sortDetached = r(function (e) {
    ...
    var ut = rt.expr.match.needsContext, dt = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, pt = /^.[^:#\[\.,]*$/;
    rt.filter = function (e, t, n) {
        var i = t[0];
        return n && (e = ":not(" + e + ")"), t.length === 1 && i.nodeType === 1 ? rt.find.matchesSelector(i, e) ? [i] : [] : rt.find.matches(e, rt.grep(t, function (e) {
            return e.nodeType === 1
        }))
    }, rt.fn.extend({
        find: function (e) {
    ...
    var ht, ft = e.document, mt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, gt = rt.fn.init = function (e, t) {
        ...
        return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : rt.isFunction(e) ? typeof ht.ready != "undefined" ? ht.ready(e) : e(rt) : (e.selector !== void 0 && (this.selector = e.selector, this.context = e.context), rt.makeArray(e, this))
    };
    gt.prototype = rt.fn, ht = rt(ft);
    var vt = /^(?:parents|prev(?:Until|All))/, yt = {children: !0, contents: !0, next: !0, prev: !0};
    rt.extend({
        dir: function (e, t, n) {
            for (var i = [], r = e[t]; r && r.nodeType !== 9 && (void 0 === n || r.nodeType !== 1 || !rt(r).is(n));) r.nodeType === 1 && i.push(r), r = r[t];
            return i
        ...
        has: function (e) {
            ...
            for (var n, i = 0, r = this.length, o = [], s = ut.test(e) || "string" != typeof e ? rt(e, t || this.context) : 0; r > i; i++) for (n = this[i]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (s ? s.index(n) > -1 : n.nodeType === 1 && rt.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
        ...
        rt.fn[e] = function (n, i) {
            ...
            return e.slice(-5) !== "Until" && (i = n), i && "string" == typeof i && (r = rt.filter(i, r)), this.length > 1 && (yt[e] || (r = rt.unique(r)), vt.test(e) && (r = r.reverse())), this.pushStack(r)
        }
    });
    var bt = /\S+/g, xt = {};
    rt.Callbacks = function (e) {
        ...
        var t, n, i, r, s, a, l = [], c = !e.once && [], u = function (o) {
            ...
            add: function () {
                ...
                return l && rt.each(arguments, function (e, n) {
                    for (var i; (i = rt.inArray(n, l, i)) > -1;) l.splice(i, 1), t && (r >= i && r--, s >= i && s--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, r = 0, o = K.call(arguments), s = o.length,
                a = 1 !== s || e && rt.isFunction(e.promise) ? s : 0, l = 1 === a ? e : rt.Deferred(),
                c = function (e, n, i) {
                    return function (r) {
                        n[e] = this, i[e] = arguments.length > 1 ? K.call(arguments) : r, i === t ? l.notifyWith(n, i) : --a || l.resolveWith(n, i)
                    }
                };
            if (s > 1) for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++) o[r] && rt.isFunction(o[r].promise) ? o[r].promise().done(c(r, i, o)).fail(l.reject).progress(c(r, n, t)) : --a;
    ...
    rt.fn.ready = function (e) {
        ...
        if (!wt) if (wt = rt.Deferred(), ft.readyState === "complete") setTimeout(rt.ready); else if (ft.addEventListener) ft.addEventListener("DOMContentLoaded", a, !1), e.addEventListener("load", a, !1); else {
    ...
    rt.extend({
        ...
        data: function (e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = rt.data(o), o.nodeType === 1 && !rt._data(o, "parsedAttrs"))) {
                    for (n = s.length; n--;) s[n] && (i = s[n].name, i.indexOf("data-") === 0 && (i = rt.camelCase(i.slice(5)), l(o, i, r[i])));
        ...
        queue: function (e, t, n) {
            ...
            t = t || "fx";
            var n = rt.queue(e, t), i = n.length, r = n.shift(), o = rt._queueHooks(e, t), s = function () {
                rt.dequeue(e, t)
            };
        ...
        queue: function (e, t) {
            ...
            return "string" != typeof e && (t = e, e = "fx", n--), arguments.length < n ? rt.queue(this[0], e) : void 0 === t ? this : this.each(function () {
                ...
                rt._queueHooks(this, e), "fx" === e && n[0] !== "inprogress" && rt.dequeue(this, e)
            })
        }, dequeue: function (e) {
            return this.each(function () {
                rt.dequeue(this, e)
    ...
    var Ct = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Nt = ["Top", "Right", "Bottom", "Left"],
        _t = function (e, t) {
            ...
            } else if (void 0 !== i && (r = !0, rt.isFunction(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
                    return c.call(rt(e), n)
                })), t)) for (; l > a; a++) t(e[a], n, s ? i : i.call(e[a], a, t(e[a], n)));
            return r ? e : c ? t.call(e) : l ? t(e[0], n) : o
        }, Dt = /^(?:checkbox|radio)$/i;
    (function () {
        var e = ft.createElement("input"), t = ft.createElement("div"), n = ft.createDocumentFragment();
        if (t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", nt.leadingWhitespace = t.firstChild.nodeType === 3, nt.tbody = !t.getElementsByTagName("tbody").length, nt.htmlSerialize = !!t.getElementsByTagName("link").length, nt.html5Clone = ft.createElement("nav").cloneNode(!0).outerHTML !== "<:nav></:nav>", e.type = "checkbox", e.checked = !0, n.appendChild(e), nt.appendChecked = e.checked, t.innerHTML = "<textarea>x</textarea>", nt.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue, n.appendChild(t), t.innerHTML = "<input type='radio' checked='checked' name='t'/>", nt.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, nt.noCloneEvent = !0, t.attachEvent && (t.attachEvent("onclick", function () {
                nt.noCloneEvent = !1
            }), t.cloneNode(!0).click()), nt.deleteExpando == null) {
            nt.deleteExpando = !0;
            try {
                delete t.test
            } catch (i) {
    ...
    var jt = /^(?:input|select|textarea)$/i, Lt = /^key/, Pt = /^(?:mouse|pointer|contextmenu)|click/,
        Ht = /^(?:focusinfocus|focusoutblur)$/, qt = /^([^.]*)(?:\.(.+)|)$/;
    rt.event = {
        global: {},
        add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, d, p, h, f, m, g = rt._data(e);
            if (g) {
                for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = rt.guid++), (s = g.events) || (s = g.events = {}), (u = g.handle) || (u = g.handle = function (e) {
                    return typeof rt === Et || e && rt.event.triggered === e.type ? void 0 : rt.event.dispatch.apply(u.elem, arguments)
                }, u.elem = e), t = (t || "").match(bt) || [""], a = t.length; a--;) o = qt.exec(t[a]) || [], h = m = o[1], f = (o[2] || "").split(".").sort(), h && (c = rt.event.special[h] || {}, h = (r ? c.delegateType : c.bindType) || h, c = rt.event.special[h] || {}, d = rt.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, l), (p = s[h]) || (p = s[h] = [], p.delegateCount = 0, c.setup && c.setup.call(e, i, f, u) !== !1 || (e.addEventListener ? e.addEventListener(h, u, !1) : e.attachEvent && e.attachEvent("on" + h, u))), c.add && (c.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, d) : p.push(d), rt.event.global[h] = !0);
                e = null
            }
        },
        remove: function (e, t, n, i, r) {
            ...
            if (g && (u = g.events)) {
                for (t = (t || "").match(bt) || [""], c = t.length; c--;) if (a = qt.exec(t[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h) {
                    for (d = rt.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = u[h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = p.length; o--;) s = p[o], !r && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (p.splice(o, 1), s.selector && p.delegateCount--, d.remove && d.remove.call(e, s));
                    l && !p.length && (d.teardown && d.teardown.call(e, f, g.handle) !== !1 || rt.removeEvent(e, h, g.handle), delete u[h])
                } else for (h in u) rt.event.remove(e, h + t[c], n, i, !0);
                rt.isEmptyObject(u) && (delete g.handle, rt._removeData(e, "events"))
            }
        },
        trigger: function (t, n, i, r) {
            var o, s, a, l, c, u, d, p = [i || ft], h = tt.call(t, "type") ? t.type : t,
            ...
            if (a = u = i = i || ft, i.nodeType !== 3 && i.nodeType !== 8 && !Ht.test(h + rt.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."), h = f.shift(), f.sort()), s = h.indexOf(":") < 0 && "on" + h, t = t[rt.expando] ? t : new rt.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : rt.makeArray(n, [t]), c = rt.event.special[h] || {}, r || !c.trigger || c.trigger.apply(i, n) !== !1)) {
                if (!r && !c.noBubble && !rt.isWindow(i)) {
                    for (l = c.delegateType || h, Ht.test(l + h) || (a = a.parentNode); a; a = a.parentNode) p.push(a), u = a;
                    u === (i.ownerDocument || ft) && p.push(u.defaultView || u.parentWindow || e)
                }
                for (d = 0; (a = p[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : c.bindType || h, o = (rt._data(a, "events") || {})[t.type] && rt._data(a, "handle"), o && o.apply(a, n), o = s && a[s], o && o.apply && rt.acceptData(a) && (t.result = o.apply(a, n), t.result === !1 && t.preventDefault());
                if (t.type = h, !r && !t.isDefaultPrevented() && (!c._default || c._default.apply(p.pop(), n) === !1) && rt.acceptData(i) && s && i[h] && !rt.isWindow(i)) {
                    u = i[s], u && (i[s] = null), rt.event.triggered = h;
                    try {
                        i[h]()
                    } catch (m) {
                    }
        ...
        dispatch: function (e) {
            e = rt.event.fix(e);
            var t, n, i, r, o, s = [], a = K.call(arguments), l = (rt._data(this, "events") || {})[e.type] || [],
                c = rt.event.special[e.type] || {};
            if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
                for (s = rt.event.handlers.call(this, e, l), t = 0; (r = s[t++]) && !e.isPropagationStopped();) for (e.currentTarget = r.elem, o = 0; (i = r.handlers[o++]) && !e.isImmediatePropagationStopped();) (!e.namespace_re || e.namespace_re.test(i.namespace)) && (e.handleObj = i, e.data = i.data, n = ((rt.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, a), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()));
                return c.postDispatch && c.postDispatch.call(this, e), e.result
            }
        },
        handlers: function (e, t) {
            var n, i, r, o, s = [], a = t.delegateCount, l = e.target;
            if (a && l.nodeType && (!e.button || e.type !== "click")) for (; l != this; l = l.parentNode || this) if (l.nodeType === 1 && (l.disabled !== !0 || e.type !== "click")) {
                for (r = [], o = 0; a > o; o++) i = t[o], n = i.selector + " ", r[n] === void 0 && (r[n] = i.needsContext ? rt(n, this).index(l) >= 0 : rt.find(n, this, null, [l]).length), r[n] && r.push(i);
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[r] = s = Pt.test(r) ? this.mouseHooks : Lt.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new rt.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
            return e.target || (e.target = o.srcElement || ft), e.target.nodeType === 3 && (e.target = e.target.parentNode), e.metaKey = !!e.metaKey, s.filter ? s.filter(e, o) : e
        },
        ...
        return this instanceof rt.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === void 0 && e.returnValue === !1 ? p : h) : this.type = e, t && rt.extend(this, t), this.timeStamp = e && e.timeStamp || rt.now(), this[rt.expando] = !0, void 0) : new rt.Event(e, t)
    }, rt.Event.prototype = {
    ...
    var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Ft = / jQuery\d+="(?:null|\d+)"/g, Ot = new RegExp("<(?:" + Mt + ")[\\s/>]", "i"), Bt = /^\s+/,
        zt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Rt = /<([\w:]+)/,
        Wt = /<tbody/i, Xt = /<|&#?\w+;/, It = /<(?:script|style|link)/i, $t = /checked\s*(?:[^=]|=\s*.checked.)/i,
        Yt = /^$|\/(?:java|ecma)script/i, Ut = /^true\/(.*)/, Vt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Kt = {
        ...
        }, Jt = m(ft), Gt = Jt.appendChild(ft.createElement("div"));
    Kt.optgroup = Kt.option, Kt.tbody = Kt.tfoot = Kt.colgroup = Kt.caption = Kt.thead, Kt.th = Kt.td, rt.extend({
        clone: function (e, t, n) {
            ...
            if (nt.html5Clone || rt.isXMLDoc(e) || !Ot.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Gt.innerHTML = e.outerHTML, Gt.removeChild(o = Gt.firstChild)), !(nt.noCloneEvent && nt.noCloneChecked || e.nodeType !== 1 && e.nodeType !== 11 || rt.isXMLDoc(e))) for (i = g(o), a = g(e), s = 0; (r = a[s]) != null; ++s) i[s] && E(r, i[s]);
            if (t) if (n) for (a = a || g(e), i = i || g(o), s = 0; (r = a[s]) != null; s++) T(r, i[s]); else T(e, o);
            return i = g(o, "script"), i.length > 0 && w(i, !l && g(e, "script")), i = a = r = null, o
        }, buildFragment: function (e, t, n, i) {
            for (var r, o, s, a, l, c, u, d = e.length, p = m(t), h = [], f = 0; d > f; f++) if (o = e[f], o || 0 === o) if (rt.type(o) === "object") rt.merge(h, o.nodeType ? [o] : o); else if (Xt.test(o)) {
                for (a = a || p.appendChild(t.createElement("div")), l = (Rt.exec(o) || ["", ""])[1].toLowerCase(), u = Kt[l] || Kt._default, a.innerHTML = u[1] + o.replace(zt, "<$1></$2>") + u[2], r = u[0]; r--;) a = a.lastChild;
                if (!nt.leadingWhitespace && Bt.test(o) && h.push(t.createTextNode(Bt.exec(o)[0])), !nt.tbody) for (o = "table" !== l || Wt.test(o) ? u[1] !== "<table>" || Wt.test(o) ? 0 : a : a.firstChild, r = o && o.childNodes.length; r--;) rt.nodeName(c = o.childNodes[r], "tbody") && !c.childNodes.length && o.removeChild(c);
                for (rt.merge(h, a.childNodes), a.textContent = ""; a.firstChild;) a.removeChild(a.firstChild);
                a = p.lastChild
            } else h.push(t.createTextNode(o));
            for (a && p.removeChild(a), nt.appendChecked || rt.grep(g(h, "input"), v), f = 0; o = h[f++];) if ((!i || rt.inArray(o, i) === -1) && (s = rt.contains(o.ownerDocument, o), a = g(p.appendChild(o), "script"), s && w(a), n)) for (r = 0; o = a[r++];) Yt.test(o.type || "") && n.push(o);
            return a = null, p
        }, cleanData: function (e, t) {
            for (var n, i, r, o, s = 0, a = rt.expando, l = rt.cache, c = nt.deleteExpando, u = rt.event.special; (n = e[s]) != null; s++) if ((t || rt.acceptData(n)) && (r = n[a], o = r && l[r])) {
                if (o.events) for (i in o.events) u[i] ? rt.event.remove(n, i) : rt.removeEvent(n, i, o.handle);
                l[r] && (delete l[r], c ? delete n[a] : typeof n.removeAttribute !== Et ? n.removeAttribute(a) : n[a] = null, V.push(r))
            }
        }
    }), rt.fn.extend({
        text: function (e) {
            ...
            for (var n, i = e ? rt.filter(e, this) : this, r = 0; (n = i[r]) != null; r++) t || n.nodeType !== 1 || rt.cleanData(g(n)), n.parentNode && (t && rt.contains(n.ownerDocument, n) && w(g(n, "script")), n.parentNode.removeChild(n));
            return this
        }, empty: function () {
            ...
            return At(this, function (e) {
                ...
                if (void 0 === e) return t.nodeType === 1 ? t.innerHTML.replace(Ft, "") : void 0;
                if (!("string" != typeof e || It.test(e) || !nt.htmlSerialize && Ot.test(e) || !nt.leadingWhitespace && Bt.test(e) || Kt[(Rt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(zt, "<$1></$2>");
                    try {
                        for (; i > n; n++) t = this[n] || {}, t.nodeType === 1 && (rt.cleanData(g(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (r) {
                    }
                }
            ...
            if (h || c > 1 && "string" == typeof p && !nt.checkClone && $t.test(p)) return this.each(function (n) {
                var i = u.eq(n);
                h && (e[0] = p.call(this, n, i.html())), i.domManip(e, t)
            });
            if (c && (a = rt.buildFragment(e, this[0].ownerDocument, !1, this), n = a.firstChild, a.childNodes.length === 1 && (a = n), n)) {
                for (o = rt.map(g(a, "script"), b), r = o.length; c > l; l++) i = a, l !== d && (i = rt.clone(i, !0, !0), r && rt.merge(o, g(i, "script"))), t.call(this[l], i, l);
                if (r) for (s = o[o.length - 1].ownerDocument, rt.map(o, x), l = 0; r > l; l++) i = o[l], Yt.test(i.type || "") && !rt._data(i, "globalEval") && rt.contains(s, i) && (i.src ? rt._evalUrl && rt._evalUrl(i.src) : rt.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Vt, "")));
                a = n = null
            }
            return this
        }
        ...
        rt.fn[e] = function (e) {
            for (var n, i = 0, r = [], o = rt(e), s = o.length - 1; s >= i; i++) n = i === s ? this : this.clone(!0), rt(o[i])[t](n), G.apply(r, n.get());
    ...
    var sn = /alpha\([^)]*\)/i, an = /opacity\s*=\s*([^)]*)/, ln = /^(none|table(?!-c[ea]).+)/,
        cn = new RegExp("^(" + Ct + ")(.*)$", "i"), un = new RegExp("^([+-])=(" + Ct + ")", "i"),
    ...
    rt.extend({
        ...
        style: function (e, t, n, i) {
            if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
                ...
                if (t = rt.cssProps[a] || (rt.cssProps[a] = N(l, a)), s = rt.cssHooks[t] || rt.cssHooks[a], void 0 === n) return s && "get" in s && (r = s.get(e, !1, i)) !== void 0 ? r : l[t];
                if (o = typeof n, "string" === o && (r = un.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(rt.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || rt.cssNumber[a] || (n += "px"), nt.clearCloneStyle || "" !== n || t.indexOf("background") !== 0 || (l[t] = "inherit"), !(s && "set" in s && (n = s.set(e, n, i)) === void 0))) try {
                    l[t] = n
                } catch (c) {
                }
            }
        ...
        css: function (e, t, n, i) {
            ...
            return t = rt.cssProps[a] || (rt.cssProps[a] = N(e.style, a)), s = rt.cssHooks[t] || rt.cssHooks[a], s && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = tn(e, t, i)), "normal" === o && t in pn && (o = pn[t]), "" === n || n ? (r = parseFloat(o), n === !0 || rt.isNumeric(r) ? r || 0 : o) : o
        }
        ...
        rt.cssHooks[e + t] = {
            expand: function (n) {
                for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Nt[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
    ...
    var fn, mn, gn = /^(?:toggle|show|hide)$/, vn = new RegExp("^(?:([+-])=|)(" + Ct + ")([a-z%]*)$", "i"),
        yn = /queueHooks$/, bn = [M], xn = {
            "*": [function (e, t) {
                var n = this.createTween(e, t), i = n.cur(), r = vn.exec(t), o = r && r[3] || (rt.cssNumber[e] ? "" : "px"),
                    s = (rt.cssNumber[e] || "px" !== o && +i) && vn.exec(rt.css(n.elem, e)), a = 1, l = 20;
                if (s && s[3] !== o) {
                    o = o || s[3], r = r || [], s = +i || 1;
    ...
    rt.Animation = rt.extend(O, {
        ...
        return i.duration = rt.fx.off ? 0 : typeof i.duration == "number" ? i.duration : i.duration in rt.fx.speeds ? rt.fx.speeds[i.duration] : rt.fx.speeds._default, (i.queue == null || i.queue === !0) && (i.queue = "fx"), i.old = i.complete, i.complete = function () {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            var r = rt.isEmptyObject(e), o = rt.speed(t, n, i), s = function () {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, r = null != e && e + "queueHooks", o = rt.timers, s = rt._data(this);
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = rt._data(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = rt.timers,
                    s = i ? i.length : 0;
        ...
        var e, t, n, i, r;
        t = ft.createElement("div"), t.setAttribute("className", "t"), t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", i = t.getElementsByTagName("a")[0], n = ft.createElement("select"), r = n.appendChild(ft.createElement("option")), e = t.getElementsByTagName("input")[0], i.style.cssText = "top:1px", nt.getSetAttribute = t.className !== "t", nt.style = /top/.test(i.getAttribute("style")), nt.hrefNormalized = i.getAttribute("href") === "/a", nt.checkOn = !!e.value, nt.optSelected = r.selected, nt.enctype = !!ft.createElement("form").enctype, n.disabled = !0, nt.optDisabled = !r.disabled, e = ft.createElement("input"), e.setAttribute("value", ""), nt.input = e.getAttribute("value") === "", e.value = "t", e.setAttribute("type", "radio"), nt.radioValue = e.value === "t"
    }();
    var wn = /\r/g;
    rt.fn.extend({
        val: function (e) {
            var t, n, i, r = this[0];
            {
                if (arguments.length) return i = rt.isFunction(e), this.each(function (n) {
                    var r;
                    this.nodeType === 1 && (r = i ? e.call(this, n, rt(this).val()) : e, null == r ? r = "" : "number" == typeof r ? r += "" : rt.isArray(r) && (r = rt.map(r, function (e) {
                        return null == e ? "" : e + ""
                    })), t = rt.valHooks[this.type] || rt.valHooks[this.nodeName.toLowerCase()], t && "set" in t && t.set(this, r, "value") !== void 0 || (this.value = r))
                });
                if (r) return t = rt.valHooks[r.type] || rt.valHooks[r.nodeName.toLowerCase()], t && "get" in t && (n = t.get(r, "value")) !== void 0 ? n : (n = r.value, "string" == typeof n ? n.replace(wn, "") : null == n ? "" : n)
            }
        }
    }), rt.extend({
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, o = e.type === "select-one" || 0 > r, s = o ? null : [], a = o ? r + 1 : i.length, l = 0 > r ? a : o ? r : 0; a > l; l++) if (n = i[l], !(!n.selected && l !== r || (nt.optDisabled ? n.disabled : n.getAttribute("disabled") !== null) || n.parentNode.disabled && rt.nodeName(n.parentNode, "optgroup"))) {
                        if (t = rt(n).val(), o) return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, i, r = e.options, o = rt.makeArray(t), s = r.length; s--;) if (i = r[s], rt.inArray(rt.valHooks.option.get(i), o) >= 0) try {
                        i.selected = n = !0
                    } catch (a) {
                        i.scrollHeight
                    } else i.selected = !1;
    ...
    rt.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === Et ? rt.prop(e, t, n) : (1 === o && rt.isXMLDoc(e) || (t = t.toLowerCase(), i = rt.attrHooks[t] || (rt.expr.match.bool.test(t) ? En : Tn)), void 0 === n ? i && "get" in i && (r = i.get(e, t)) !== null ? r : (r = rt.find.attr(e, t), null == r ? void 0 : r) : null !== n ? i && "set" in i && (r = i.set(e, n, t)) !== void 0 ? r : (e.setAttribute(t, n + ""), n) : (rt.removeAttr(e, t), void 0))
        }, removeAttr: function (e, t) {
            var n, i, r = 0, o = t && t.match(bt);
            if (o && e.nodeType === 1) for (; n = o[r++];) i = rt.propFix[n] || n, rt.expr.match.bool.test(n) ? Nn && Cn || !Sn.test(n) ? e[i] = !1 : e[rt.camelCase("default-" + n)] = e[i] = !1 : rt.attr(e, n, ""), e.removeAttribute(Cn ? n : i)
        }, attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? rt.removeAttr(e, n) : Nn && Cn || !Sn.test(n) ? e.setAttribute(!Cn && rt.propFix[n] || n, n) : e[rt.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, rt.each(rt.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = kn[t] || rt.find.attr;
        kn[t] = Nn && Cn || !Sn.test(t) ? function (e, t, i) {
            var r, o;
            return i || (o = kn[t], kn[t] = r, r = n(e, t, i) != null ? t.toLowerCase() : null, kn[t] = o), r
        } : function (e, t, n) {
            return n ? void 0 : e[rt.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }), Nn && Cn || (rt.attrHooks.value = {
        set: function (e, t, n) {
            return rt.nodeName(e, "input") ? (e.defaultValue = t, void 0) : Tn && Tn.set(e, t, n)
        }
    }), Cn || (Tn = {
        set: function (e, t, n) {
    ...
    var _n = /^(?:input|select|textarea|button|object)$/i, An = /^(?:a|area)$/i;
    rt.fn.extend({
        prop: function (e, t) {
        ...
        propFix: {"for": "htmlFor", "class": "className"}, prop: function (e, t, n) {
            ...
            if (e && 3 !== s && 8 !== s && 2 !== s) return o = 1 !== s || !rt.isXMLDoc(e), o && (t = rt.propFix[t] || t, r = rt.propHooks[t]), void 0 !== n ? r && "set" in r && (i = r.set(e, n, t)) !== void 0 ? i : e[t] = n : r && "get" in r && (i = r.get(e, t)) !== null ? i : e[t]
        }, propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    rt.fn.extend({
        addClass: function (e) {
            ...
            if (c) for (t = (e || "").match(bt) || []; l > a; a++) if (n = this[a], i = n.nodeType === 1 && (n.className ? (" " + n.className + " ").replace(Dn, " ") : " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : rt.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n) for (var t, i = 0, r = rt(this), o = e.match(bt) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
            ...
            for (var t = " " + e + " ", n = 0, i = this.length; i > n; n++) if (this[n].nodeType === 1 && (" " + this[n].className + " ").replace(Dn, " ").indexOf(t) >= 0) return !0;
            return !1
        }
    ...
    var Hn, qn, Mn = /#.*$/, Fn = /([?&])_=[^&]*/, On = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Bn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, zn = /^(?:GET|HEAD)$/, Rn = /^\/\//,
        Wn = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Xn = {}, In = {}, $n = "*/".concat("*");
    try {
        qn = location.href
    } catch (Yn) {
        qn = ft.createElement("a"), qn.href = "", qn = qn.href
    }
    Hn = Wn.exec(qn.toLowerCase()) || [], rt.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (e, t) {
            function n(e, t, n, i) {
                var r, u, v, y, x, T = t;
                2 !== b && (b = 2, a && clearTimeout(a), c = void 0, s = i || "", w.readyState = e > 0 ? 4 : 0, r = e >= 200 && 300 > e || 304 === e, n && (y = W(d, w, n)), y = X(d, y, w, r), r ? (d.ifModified && (x = w.getResponseHeader("Last-Modified"), x && (rt.lastModified[o] = x), x = w.getResponseHeader("etag"), x && (rt.etag[o] = x)), 204 === e || d.type === "HEAD" ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = y.state, u = y.data, v = y.error, r = !v)) : (v = T, (e || !T) && (T = "error", 0 > e && (e = 0))), w.status = e, w.statusText = (t || T) + "", r ? f.resolveWith(p, [u, T, w]) : f.rejectWith(p, [w, T, v]), w.statusCode(g), g = void 0, l && h.trigger(r ? "ajaxSuccess" : "ajaxError", [w, d, r ? u : v]), m.fireWith(p, [w, T]), l && (h.trigger("ajaxComplete", [w, d]), --rt.active || rt.event.trigger("ajaxStop")))
            }

            "object" == typeof e && (t = e, e = void 0), t = t || {};
            var i, r, o, s, a, l, c, u, d = rt.ajaxSetup({}, t), p = d.context || d,
                h = d.context && (p.nodeType || p.jquery) ? rt(p) : rt.event, f = rt.Deferred(),
                m = rt.Callbacks("once memory"), g = d.statusCode || {}, v = {}, y = {}, b = 0, x = "canceled", w = {
                    readyState: 0, getResponseHeader: function (e) {
                        var t;
                        if (2 === b) {
                            if (!u) for (u = {}; t = On.exec(s);) u[t[1].toLowerCase()] = t[2];
                            t = u[e.toLowerCase()]
                        }
    ...
    var Qn = 0, Zn = {}, ei = rt.ajaxSettings.xhr();
        ...
        if (!e.crossDomain || nt.cors) {
            ...
            return {
                send: function (n, i) {
                    ...
                    for (r in n) n[r] !== void 0 && o.setRequestHeader(r, n[r] + "");
                    o.send(e.hasContent && e.data || null), t = function (n, r) {
                        var a, l, c;
                        if (t && (r || o.readyState === 4)) if (delete Zn[s], t = void 0, o.onreadystatechange = rt.noop, r) o.readyState !== 4 && o.abort(); else {
                            c = {}, a = o.status, typeof o.responseText == "string" && (c.text = o.responseText);
                            try {
                                l = o.statusText
                            } catch (u) {
                                l = ""
    ...
    rt.ajaxSetup({
        ...
        var r, o, s,
            a = t.jsonp !== !1 && (ni.test(t.url) ? "url" : typeof t.data == "string" && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && ni.test(t.data) && "data");
        return a || t.dataTypes[0] === "jsonp" ? (r = t.jsonpCallback = rt.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(ni, "$1" + r) : t.jsonp !== !1 && (t.url += (Ln.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
    ...
    rt.offset = {
        setOffset: function (e, t, n) {
            ...
            "static" === u && (e.style.position = "relative"), a = d.offset(), o = rt.css(e, "top"), l = rt.css(e, "left"), c = ("absolute" === u || "fixed" === u) && rt.inArray("auto", [o, l]) > -1, c ? (i = d.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), rt.isFunction(t) && (t = t.call(e, n, a)), t.top != null && (p.top = t.top - a.top + s), t.left != null && (p.left = t.left - a.left + r), "using" in t ? t.using.call(e, p) : d.css(p)
        }
    }, rt.fn.extend({
        offset: function (e) {
            ...
            if (o) return t = o.documentElement, rt.contains(t, r) ? (typeof r.getBoundingClientRect !== Et && (i = r.getBoundingClientRect()), n = U(o), {
            ...
            if (this[0]) {
                ...
                return rt.css(i, "position") === "fixed" ? t = i.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), rt.nodeName(e[0], "html") || (n = e.offset()), n.top += rt.css(e[0], "borderTopWidth", !0), n.left += rt.css(e[0], "borderLeftWidth", !0)), {
            ...
            return this.map(function () {
                for (var e = this.offsetParent || ri; e && !rt.nodeName(e, "html") && rt.css(e, "position") === "static";) e = e.offsetParent;
                return e || ri
            })
        }
        ...
        rt.fn[e] = function (i) {
            return At(this, function (e, i, r) {
                var o = U(e);
                return void 0 === r ? o ? t in o ? o[t] : o.document.documentElement[i] : e[i] : (o ? o.scrollTo(n ? rt(o).scrollLeft() : r, n ? r : rt(o).scrollTop()) : e[i] = r, void 0)
        ...
        rt.each({padding: "inner" + e, content: t, "": "outer" + e}, function (n, i) {
            rt.fn[i] = function (i, r) {
                ...
                return At(this, function (t, n, i) {
                    var r;
                    return rt.isWindow(t) ? t.document.documentElement["client" + e] : t.nodeType === 9 ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === i ? rt.css(t, n, s) : rt.style(t, n, i, s)
                }, t, o ? i : void 0, o, null)
            }
        })
    }), rt.fn.size = function () {
    ...
    e.fn.jTruncate = function (t) {
        ...
        return this.each(function () {
            ...
            if (n.length > t.length + t.minTrail) {
                ...
                if (-1 != i) {
                    var i = n.indexOf(" ", t.length), r = n.substring(0, i), o = n.substring(i, n.length - 1);
                    obj.html(r + '<span class="truncate_ellipsis">' + t.ellipsisText + "</span>" + '<span class="truncate_more">' + o + "</span>"), obj.find(".truncate_more").css("display", "none"), obj.append('&nbsp;<a href="#" class="truncate_more_link collapsed">' + t.moreText + "</a>");
                    var s = e(".truncate_more_link", obj), a = e(".truncate_more", obj),
                        l = e(".truncate_ellipsis", obj);
                    s.click(function () {
                        return s.hasClass("collapsed") ? (a.show(t.moreAni), s.html(t.lessText), l.css("display", "none"), s.toggleClass("collapsed")) : (a.hide(t.lessAni), s.html(t.moreText), l.css("display", "inline"), s.toggleClass("collapsed")), !1
                    })
                }
            }
        })
    ...
    function i(n, i) {
        this.wrapper = "string" == typeof n ? t.querySelector(n) : n, this.scroller = this.wrapper.children[0], this.scrollerStyle = this.scroller.style, this.options = {
    ...
    var r = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || function (t) {
        ...
        var r = {}, o = t.createElement("div").style, s = function () {
            for (var e, t = ["t", "webkitT", "MozT", "msT", "OT"], n = 0, i = t.length; i > n; n++) if (e = t[n] + "ransform", e in o) return t[n].substr(0, t[n].length - 1);
            return !1
        }();
        r.getTime = Date.now || function () {
            ...
            return s = void 0 === s ? 6e-4 : s, a = e + u * u / (2 * s) * (0 > c ? -1 : 1), l = u / s, r > a ? (a = o ? r - o / 2.5 * (u / 8) : r, c = n.abs(a - e), l = c / u) : a > 0 && (a = o ? o / 2.5 * (u / 8) : 0, c = n.abs(e) + a, l = c / u), {
        ...
        return r.extend(r, {
            ...
            var i, r = n.target;
            /(SELECT|INPUT|TEXTAREA)/i.test(r.tagName) || (i = t.createEvent(e.MouseEvent ? "MouseEvents" : "Event"), i.initEvent("click", !0, !0), i.view = n.view || e, i.detail = 1, i.screenX = r.screenX || 0, i.screenY = r.screenY || 0, i.clientX = r.clientX || 0, i.clientY = r.clientY || 0, i.ctrlKey = !!n.ctrlKey, i.altKey = !!n.altKey, i.shiftKey = !!n.shiftKey, i.metaKey = !!n.metaKey, i.button = 0, i.relatedTarget = null, i._constructed = !0, r.dispatchEvent(i))
    ...
    i.prototype = {
        version: "5.2.0-snapshot", _init: function () {
            ...
            if (this.enabled && o.eventType[e.type] === this.initiated) {
                ...
                var t, i, r, s, a = e.touches ? e.touches[0] : e, l = a.pageX - this.pointX, c = a.pageY - this.pointY,
                    u = o.getTime();
                if (this.pointX = a.pageX, this.pointY = a.pageY, this.distX += l, this.distY += c, r = n.abs(this.distX), s = n.abs(this.distY), !(u - this.endTime > 300 && 10 > r && 10 > s)) {
                    if (this.directionLocked || this.options.freeScroll || (this.directionLocked = r > s + this.options.directionLockThreshold ? "h" : s >= r + this.options.directionLockThreshold ? "v" : "n"), this.directionLocked == "h") {
                        if (this.options.eventPassthrough == "vertical") e.preventDefault(); else if (this.options.eventPassthrough == "horizontal") return this.initiated = !1, void 0;
                        c = 0
                    } else if (this.directionLocked == "v") {
                        if (this.options.eventPassthrough == "horizontal") e.preventDefault(); else if (this.options.eventPassthrough == "vertical") return this.initiated = !1, void 0;
                        l = 0
                    }
            ...
            if (this.enabled && o.eventType[e.type] === this.initiated) {
                ...
                var t, i, r = (e.changedTouches ? e.changedTouches[0] : e, o.getTime() - this.startTime),
                    s = n.round(this.x), a = n.round(this.y), l = n.abs(s - this.startX), c = n.abs(a - this.startY),
                    u = 0, d = "";
                if (this.isInTransition = 0, this.initiated = 0, this.endTime = o.getTime(), !this.resetPosition(this.options.bounceTime)) return this.scrollTo(s, a), this.moved ? this._events.flick && 200 > r && 100 > l && 100 > c ? (this._execEvent("flick"), void 0) : (this.options.momentum && 300 > r && (t = this.hasHorizontalScroll ? o.momentum(this.x, this.startX, r, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                    destination: s,
                    duration: 0
                    ...
                    destination: a,
                    duration: 0
                }, s = t.destination, a = i.destination, u = n.max(t.duration, i.duration), this.isInTransition = 1), s != this.x || a != this.y ? ((s > 0 || s < this.maxScrollX || a > 0 || a < this.maxScrollY) && (d = o.ease.quadratic), this.scrollTo(s, a, u, d), void 0) : (this._execEvent("scrollEnd"), void 0)) : (this.options.tap && o.tap(e, this.options.tap), this.options.click && o.click(e), this._execEvent("scrollCancel"), void 0)
            }
        }, _resize: function () {
            var e = this;
            ...
            this.options.useTransform ? this.scrollerStyle[o.style.transform] = "translate(" + e + "px," + t + "px)" + this.translateZ : (e = n.round(e), t = n.round(t), this.scrollerStyle.left = e + "px", this.scrollerStyle.top = t + "px"), this.x = e, this.y = t
        }, _initEvents: function (t) {
            var n = t ? o.removeEvent : o.addEvent, i = this.options.bindToWrapper ? this.wrapper : e;
            ...
            return this.options.useTransform ? (i = i[o.style.transform].split(")")[0].split(", "), t = +(i[12] || i[4]), n = +(i[13] || i[5])) : (t = +i.left.replace(/[^-\d.]/g, ""), n = +i.top.replace(/[^-\d.]/g, "")), {
                x: t,
                y: n
            }
            ...
            function s() {
                ...
                return m >= d ? (a.isAnimating = !1, a._translate(e, t), a.resetPosition(a.options.bounceTime) || a._execEvent("scrollEnd"), void 0) : (m = (m - u) / n, f = i(m), p = (e - l) * f + l, h = (t - c) * f + c, a._translate(p, h), a.isAnimating && r(s), void 0)
            }

            var a = this, l = this.x, c = this.y, u = o.getTime(), d = u + n;
    ...
    }, i.utils = o, "undefined" != typeof module && module.exports ? module.exports = i : "function" == typeof define && define.amd ? define(function () {
        return i
    }) : e.IScroll = i
...
PrivacyPolicy.prototype.start = function () {
    this.readConfFromUrl(), this.updateStyles(), this.checkForMobile(), this.checkAnchors(), this.checkAnalyticsMode()
}, PrivacyPolicy.prototype.readConfFromUrl = function () {
    this.inIframe = getParameterByName("ifr") == "true", this.wHeight = getParameterByName("height") ? parseInt(getParameterByName("height")) : this.inIframe ? 600 : null, this.skipAnalytics = getParameterByName("an") == "no", this.phantomJs = getParameterByName("phantomjs") == "true"
}, PrivacyPolicy.prototype.updateStyles = function () {
    this.inIframe ? (this.cssString += "#leo_policy #wbars {height:" + (this.noBrand ? this.wHeight : (this.wHeight || 0) - 81) + "px;}\n", this.cssString += "#leo_policy .l_container > .l_footer {  -webkit-box-shadow: none;  -moz-box-shadow: none;  box-shadow: none;  border-top: 1px solid #DDD; }\n", this.cssString += "#leo_policy.leo_vip_policy.leo_fixed_policy .l_container {max-width: none; padding-top: 0;}") : (this.cssString += "#leo_policy .close {display: none;}\n", this.cssString += "#leo_policy #wbars {   overflow-y: auto;   -webkit-box-shadow: none;   -moz-box-shadow: none;   box-shadow: none;   height: auto; }\n", this.cssString += "#leo_policy .l_container {  margin-top: 30px;  margin-bottom: 30px; }\n", this.cssString += "#leo_policy .l_container > .l_footer {  -webkit-box-shadow: none;  -moz-box-shadow: none;  box-shadow: none;  -webkit-border-radius: none;  -moz-border-radius: none;  border-radius: none; }\n"), insertStylesheet(this.cssString)
    ...
    if (e.inIframe) {
        ...
        t && (window.addEventListener("load", e.loadedForMobile, !1), $(".expand .expand-click").click(function () {
            setTimeout(function () {
    ...
    var e = this;
    setTimeout(function () {
        window.myScroll ? window.myScroll.destroy() : null, window.myScroll = null;
        var t = e.inIframe ? document.getElementById("wbars_all") : document.getElementById("wbars");
        window.myScroll = new IScroll(t, {useTransition: !0, click: !0})
    }, 0)
}, PrivacyPolicy.prototype.checkAnchors = function () {
    var e = this;
    $(".l_container").find("a").each(function () {
